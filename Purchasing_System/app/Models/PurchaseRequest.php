...
class PurchaseRequest extends Model
{
    ...
    protected $fillable=['no_pr','role','feedback','type','deadline_date','color_id','locations_id','ships_id', 'requester', 'prefixes_id', 'project', 'note', 'attachment','tanggal_diterima'];
