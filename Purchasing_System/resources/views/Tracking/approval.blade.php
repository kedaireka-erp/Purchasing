    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <p class="font-w600 fs-18"><a href="javascript:void(0);" class="text-black">{{ $purchase_request->no_pr }}</a></p>
                <div class="progress default-progress my-4">
                    @if($purchase_request->approval_status == 'pending' && $purchase_request->accept_status == 'pending')
                    <div class="progress-bar bg-danger progress-animated" style="width: 30%; height:10px;" role="progressbar">
                        @elseif($purchase_request->approval_status == 'approve' && $purchase_request->accept_status == 'pending')
                        <div class="progress-bar bg-warning progress-animated" style="width: 60%; height:10px;" role="progressbar">
                ...
                <div class="d-flex justify-content-between align-items-center kanban-user">
                    ...
                    <div class="text">
                        ...
                        <span><i class="far fa-clock me-2"></i>{{ Carbon\Carbon::parse($purchase_request->deadline_date)->diffForHumans()}} </span>
