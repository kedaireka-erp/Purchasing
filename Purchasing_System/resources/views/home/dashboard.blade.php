...
@section('title_content', 'Dashboard Purchasing Divisi')
            ...
            <div class="col-xl-5 col-sm-6">
                <div class="card  border-left-success shadow h-100 py-2">
                    <div class="card-header border-0">
                        <div>
                            <h4 class="fs-20 font-w700" style="font-weight:500">Pesanan </h4>
                            <span class="fs-14 font-w400 d-block">Pending And Done</span>
                        </div>	
                    </div>	
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center justify-content-between  mb-4">
                                ...
                                <span class="fs-18 font-w600">{{ $done }} </span>
                            </div>
    ...
    <script>
      var emailchart = function(){
		 var options = {
          ...
          series: [ {!! json_encode($done) !!},{!! json_encode($pending) !!},],
          chart: {
          type: 'donut',
		  height:300
        },
