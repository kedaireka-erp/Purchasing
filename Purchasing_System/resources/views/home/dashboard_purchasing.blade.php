...
@section('title_content', 'Dashboard Purchasing')
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                style="color:#ABD9FF; font-size: 30px; font-weight:bold">{{ $orders }} </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1"
                                style="color:#FF1E1E; font-size: 15px">
                                Reject </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                style="color:#FF1E1E; font-size: 30px; font-weight:bold">
                                {{ $reject }}</div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold  text-uppercase mb-1"
                                style="color:#C7F2A4; font-size: 15px">
                                Powder</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                style="color:#C7F2A4; font-size: 30px; font-weight:bold">
                                {{ $jmlpowder }} </div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold  text-uppercase mb-1"
                                style="color:#FFD384; font-size: 15px">
                                Other Good</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"
                                style="color:#FFD384; font-size: 30px; font-weight:bold">
                                {{ $jmlother }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <span class="fs-18 font-w600">{{ $prmasuk }}</span>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between  mb-4">
                            ...
                            <span class="fs-18 font-w600">{{ $poselesai }} </span>
                        </div>
        ...
        <div class="col-xl-7 col-sm-6">
            <div class="card  border-left-success shadow h-100 py-2">
                ...
                <div class="card-body">
                    ...
                    {{ $purchase_requests_pending->links() }}
                </div>
            </div>
        </div>
    </div>
        ...
        <script>
            var emailchart = function() {
                var options = {
                    ...
                    series: [{!! json_encode($poselesai) !!}, {!! json_encode($prmasuk) !!}, {!! json_encode($reject) !!}],
                    chart: {
                        type: 'donut',
                        height: 300
                    },
