    ...
    <div class="card-body">
        ...
        <div class="tab-content" style="margin-top:70px">
            <div id="navpills-1" class="tab-pane active">
                <div class="row">
                    <div> 
                        <form action="{{ route('finance.purchase_request.storepowder_finance') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                  <div class="col-6">
                                      <div class="mb-3">
            ...
            <div id="navpills-2" class="tab-pane">
                <form action="{{ route('finance.purchase_request.storegood_finance') }}" method="post"
