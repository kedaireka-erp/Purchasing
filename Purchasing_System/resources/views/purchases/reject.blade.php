                    ...
                    <div class="profile-tab">
                        <div class="custom-tab-1">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a href="#reject_manager" data-bs-toggle="tab" class="nav-link active show"> Feedback Manager </a>
                                </li>
                                @elseif($purchase_requests->accept_status == 'reject')
                                <li class="nav-item"><a href="#reject_purchasing" data-bs-toggle="tab" class="nav-link active show"> Feedback Purchasing </a>
                                </li>
                                @endif
                                ...
                                <div id="reject_manager" class="tab-pane fade active show">
                                    <div class="profile-reject_manager">
                                          <div class="mb-3">
                                                ...
                                                <textarea name="tanggal_diterima" class="form-control wide"
                                                    disabled>{{ $purchase_requests->feedback_manager }}  </textarea>
                                          </div>
                                          <div class="mb-3">
                                                <a href="{{ route('purchase_request.create') }}" style="width: 100%" class="btn btn-primary"> Buat PR Baru </a>
                                                    </div>
                                          </div>
                                            <div class="mb-3">
                                ...
                                <div id="reject_purchasing" class="tab-pane fade active show">
                                    <div class="profile-reject_purchasing">
                                          <div class="mb-3">
                                                ...
                                                <textarea name="tanggal_diterima" class="form-control wide"
                                                    disabled>{{ $purchase_requests->feedback_purchasing }}  </textarea>
                                          </div>
                                            <div class="mb-3">
                                                <div class="mb-3">
                                                      <a href="{{ route('purchase_request.edit', $purchase_requests->id) }}" style="width: 100%" class="btn btn-primary"> Revisi PR </a>
                                                          </div>
                                                </div>
                                                <div class="mb-3">
                                                      <a href="{{ route('purchase_request.create') }}" style="width: 100%" class="btn btn-info"> Buat PR Baru </a>
                                                          </div>
                                                </div>
                                            <div class="mb-3">
                                                <form
