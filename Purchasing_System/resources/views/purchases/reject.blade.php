                    ...
                    <div class="profile-tab">
                            ...
                            <div class="tab-content">
                                ...
                                @if ($purchase_requests->approval_status == 'reject')
                                    <div id="reject_manager" class="tab-pane fade active show">
                                        <div class="profile-reject_manager pt-3">
                                            <div class="mb-3">
                                                <p style="font-weight: bold" class="form-label"> Alasan
                                                    Reject Manager
                                                </p>
                        ...
                        @elseif($purchase_requests->accept_status == 'reject')
                            <div id="reject_purchasing" class="tab-pane fade active show">
                                <div class="profile-reject_purchasing pt-3">
                                    <div class="mb-3">
                                        <p style="font-weight: bold" class="form-label"> Alasan Reject Tim
                                            Purchasing </p>
